package com.restaurantordering;
...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/ordering?useUnicode=true&useSSL=false&characterEncoding=utf8");
...
//        globalConfig.setAuthor("");    //设置作者
        ...
        globalConfig.setIdType(IdType.NONE);   //设置Id生成策略 ASSIGN_ID
        autoGenerator.setGlobalConfig(globalConfig);

        //设置包名相关配置
        PackageConfig packageInfo = new PackageConfig();
        packageInfo.setParent("com.restaurantordering");   //设置生成的包名，与代码所在位置不冲突，二者叠加组成完整路径
        ...
        strategyConfig.setInclude("orders_item");  //设置当前参与生成的表名，参数为可变参数
